--Write a query that retrieves the columns ProductID, Name, Color and ListPrice 
...
--Write a query that concatenates the columns Name and Color 
...
--Write a query to retrieve the to the columns ProductID and Name 
--from the Production.Product table filtered by ProductID from 400 to 500
SELECT ProductID, Name
FROM Production.Product
WHERE ProductID BETWEEN 400 AND 500;

--Write a query to retrieve the to the columns  ProductID, Name and color 
